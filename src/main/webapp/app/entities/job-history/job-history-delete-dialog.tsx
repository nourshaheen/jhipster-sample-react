...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleReactApp.jobHistory.delete.question">
        <Translate contentKey="jhipsterSampleReactApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>

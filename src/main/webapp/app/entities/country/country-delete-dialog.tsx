...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleReactApp.country.delete.question">
        <Translate contentKey="jhipsterSampleReactApp.country.delete.question" interpolate={{ id: countryEntity.id }}>

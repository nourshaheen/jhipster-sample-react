...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleReactApp.location.delete.question">
        <Translate contentKey="jhipsterSampleReactApp.location.delete.question" interpolate={{ id: locationEntity.id }}>

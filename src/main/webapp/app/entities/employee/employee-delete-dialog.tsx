...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleReactApp.employee.delete.question">
        <Translate contentKey="jhipsterSampleReactApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>

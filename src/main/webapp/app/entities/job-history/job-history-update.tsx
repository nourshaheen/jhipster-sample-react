  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleReactApp.jobHistory.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleReactApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('jhipsterSampleReactApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('jhipsterSampleReactApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('jhipsterSampleReactApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>

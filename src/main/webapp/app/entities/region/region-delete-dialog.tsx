...
export const RegionDeleteDialog = (props: IRegionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleReactApp.region.delete.question">
        <Translate contentKey="jhipsterSampleReactApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
